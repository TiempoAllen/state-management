  ...
  return (
    <div className="container2">
      ...
      <Queue
        ...
        regular1Duration={regular1Duration}
        regular2Duration={regular2Duration}
        regular3Duration={regular3Duration}
        regularTask1={regularTask1}
        regularTask2={regularTask2}
        regularTask3={regularTask3}
      />
    </div>
  );
};
